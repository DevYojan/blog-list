...
describe('Author with most likes', () => {
	test('returns empty object if empty array is passed', () => {
		const blogs = [];

		expect(listHelper.mostLikes(blogs)).toEqual({});
	});

	test('returns the same author if there is only a single blog', () => {
		const blogs = [
			{
				_id: '5a422bc61b54a676234d17fc',
				title: 'Type wars',
	...
	test('returns correct author if many blogs are passed', () => {
		const blogs = [
			{
				_id: '5a422a851b54a676234d17f7',
				title: 'React patterns',
